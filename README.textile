...
# @mvn compile@
# add @target/javasizer-jar-with-dependencies.jar@ to your classpath

*OR*

Grab the latest jar from here: "http://github.com/hoffrocket/javasizer/downloads":http://github.com/hoffrocket/javasizer/downloads and add to your classpath

h3. How to use

@org.jh.Sizer.sizeof(root)@  will return the bytes used by the object graph.

_Note: this probably requires Java 1.5 or higher_
